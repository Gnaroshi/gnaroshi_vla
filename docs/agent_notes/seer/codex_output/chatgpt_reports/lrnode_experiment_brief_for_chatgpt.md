...
- Baseline Seer: 매 step마다 full visual encoder/transformer/action head 실행
...
- 방법 tag: `lrnode_student_v2_lw05_aw01_g4`
...
| 실행 | SR | Full Seer call 감소율 | 유효 full-query Hz | Policy latency | 해석 |
|---|---:|---:|---:|---:|---|
...
| 항목 | K=2 | K=4 |
|---|---:|---:|
| baseline 대비 success preservation | 99.4% | 100.6% |
| baseline 대비 policy latency 감소율 | 37.7% | 57.2% |
| Full Seer call 감소율 | 49.9% | 74.9% |
...
| 실행 | SR | Full Seer call 감소율 | 유효 full-query Hz | Policy latency | Videos |
|---|---:|---:|---:|---:|---:|
