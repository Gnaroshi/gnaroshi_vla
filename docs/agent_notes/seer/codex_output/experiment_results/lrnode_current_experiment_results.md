...
| 결과 root | `scratch_eval_lrnode/lrnode_compare_lrnode_student_v2_lw05_aw01_g4_ckpt35_vs_seer_original_ckpt37_20260615_001039` |

## 2. 전체 결과

| 실행 | SR | Delta SR | Preservation | Full-query red. | Full Hz | Policy mean | Policy red. | Full call | LR call | Mean ep. jerk p95 | Videos |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
