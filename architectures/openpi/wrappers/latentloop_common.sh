...
export HF_HOME=${OPENPI_LL_SHARED}/cache/openpi/huggingface
export HF_LEROBOT_HOME=${OPENPI_LL_SHARED}/cache/openpi/lerobot
export HF_DATASETS_CACHE=${OPENPI_LL_SHARED}/cache/openpi/huggingface/datasets
export UV_CACHE_DIR=${OPENPI_LL_SHARED}/cache/openpi/uv
export XDG_CACHE_HOME=${OPENPI_LL_SHARED}/cache/openpi/xdg
export WANDB_DIR=${OPENPI_LL_SHARED}/results/openpi/wandb
