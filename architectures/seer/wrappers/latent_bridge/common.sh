...
LATENT_BRIDGE_PAPER_CHECKPOINT_ROOT="${LATENT_BRIDGE_PAPER_CHECKPOINT_ROOT:-/home/mingyujung/shared/nvme1/mingyujung/robotics/gnaroshi_vla/artifacts/checkpoints/seer/paper}"
LATENT_BRIDGE_BASE_CHECKPOINT="${LATENT_BRIDGE_BASE_CHECKPOINT:-${LATENT_BRIDGE_PUBLIC33:-${LATENT_BRIDGE_PAPER_CHECKPOINT_ROOT}/libero_long/teacher_public33.pth}}"
...
LATENT_BRIDGE_RESULT_ROOT="${LATENT_BRIDGE_RESULT_ROOT:-/home/mingyujung/shared/nvme1/mingyujung/robotics/gnaroshi_vla/results/seer/latent_bridge/libero_long}"
