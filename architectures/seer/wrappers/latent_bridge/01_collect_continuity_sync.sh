...
if ! latent_bridge_eval_row_is_complete "${calibration}" 42 2 10; then
    latent_bridge_prepare_eval_row "${calibration}" 42 2 10
...
sync="${stage}/sync_300"
if ! latent_bridge_eval_row_is_complete "${sync}" 42 30 10; then
    latent_bridge_prepare_eval_row "${sync}" 42 30 10
