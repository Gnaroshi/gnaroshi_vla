...
The following files contain LR-NODE / ours-method markers and should be treated
...
- `models/lrnode_modules.py`: LR-NODE method modules. This is method-owned code
  and should eventually move under `architectures/seer/ours/`.
...
- `codex_output/lrnode_*.md` and `codex_output/ours_vs_baseline_pipeline_analysis.md`:
  method analysis and experiment notes.
