...
class SeerController:
    ...
    def setup_model(self):
        self.model = SeerAgent(
            ...
            use_lrnode_latent_update=self.args.use_lrnode_latent_update,
            lrnode_hidden_dim=self.args.lrnode_hidden_dim,
            lrnode_motion_dim=self.args.lrnode_motion_dim,
            lrnode_fast_encoder_type=self.args.lrnode_fast_encoder_type,
            lrnode_gate_init_bias=self.args.lrnode_gate_init_bias,
            lrnode_trace=self.args.lrnode_trace,
        )
