...
# from utils.train_utils_3dpointcloud_origin import get_cast_dtype
from utils.train_utils_ours_0406 import get_cast_dtype
...
class ModelWrapper:
    ...
    def step(self, obs, goal, timestep):
        ...
        with torch.no_grad():
            ...
            arm_action = outputs[0]
            gripper_action = outputs[1]
