...
SOURCE_FILES = (
    ...
    "architectures/simvla/adapters/latentloop/efficient_multirate/mechanical_control_policy.py",
    "architectures/simvla/adapters/latentloop/efficient_multirate/replay_control_aggregate.py",
    ...
    "architectures/simvla/wrappers/run_simvla_replay_controls_rb2.sh",
)
