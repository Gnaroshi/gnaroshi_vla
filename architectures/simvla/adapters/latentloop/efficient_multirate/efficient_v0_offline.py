"""Run the unchanged native V0 offline evaluator under an efficient child lock."""
...
from architectures.simvla.adapters.latentloop import native_v0_offline
...
def main() -> int:
    ...
    install_native_evaluator_lineage_bridge(native_v0_offline, child_source)
    sys.argv = [sys.argv[0], *remaining]
    return native_v0_offline.main()
