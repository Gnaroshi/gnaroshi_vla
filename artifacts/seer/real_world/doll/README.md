...
Teacher 38 is the DROID-finetuned Seer checkpoint trained on the 40-episode Doll
dataset. Adapter 39 was trained on s4 with that exact frozen teacher. Do not mix
the adapter with another teacher checkpoint.
