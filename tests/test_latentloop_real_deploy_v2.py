...
def test_unified_shell_uses_existing_control_freq_name_and_defaults_to_live():
...
def test_v2_result_metadata_uses_control_freq_and_records_rollout_settings(tmp_path):
    ...
    app.cfg = SimpleNamespace(home_configuration={
        "task": "doll_filtered_40p",
        "joint_positions_rad": [3.0502887, -1.6030570, 1.8191951, -1.8019783, -1.5417574, -1.6144441],
    ...
    assert payload["metadata"]["home_configuration"] == app.cfg.home_configuration
